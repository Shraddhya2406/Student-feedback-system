                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" type="text"
                                            ...
                                            value="{{ $user->name }}" required autocomplete="name" disabled>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="depertment" type="text"
                                            class="form-control @error('depertment') is-invalid @enderror"
                                            name="depertment" required value="{{ $user->depertment }}">
